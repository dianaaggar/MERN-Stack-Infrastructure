...
// handleSubmit = (evt) => {
//     evt.preventDefault(); //Prevent default form 
//     alert(JSON.stringify(this.state)); // Display form state as JSON
// };
...
////-------Transform to functional components-------------///
...
//     let disable = state?state.password !== state.confirm:false;
//     return (
//         <div>
//             <div className="form-container">
//                 <form autoComplete="off" onSubmit={handleSubmit}>
